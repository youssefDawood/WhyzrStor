...
{
    [DbContext(typeof(WhyzrStoreMigrationsDbContext))]
    [Migration("20210303154222_Add_Index_To_Branches_And_Warehouses")]
    partial class Add_Index_To_Branches_And_Warehouses
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WhyzrStore.Branches.Branch", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("WhyzrStore.Warehouses.Warehouse", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("WhyzrStore.Branches.Branch", b =>
                {
                    b.HasOne("WhyzrStore.Branches.Branch", null)
                        .WithMany()
                        .HasForeignKey("ParentId");
                });
